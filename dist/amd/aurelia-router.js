define('aurelia-router', ['exports', 'aurelia-route-recognizer', 'aurelia-dependency-injection', 'aurelia-logging', 'aurelia-history', 'aurelia-event-aggregator'], function (exports, aureliaRouteRecognizer, aureliaDependencyInjection, LogManager, aureliaHistory, aureliaEventAggregator) { 'use strict';
    ...
    */
    ...
    var RedirectToRoute = /** @class */ (function (_super) {
        __extends(RedirectToRoute, _super);
        /**
                ...
                switch (_a.label) {
                    case 0:
                        if ("moduleId" /* moduleId */ in viewPortInstruction) {
                            return [2 /*return*/, viewPortInstruction.moduleId];
                        }
                        if (!("viewModel" /* viewModel */ in viewPortInstruction)) return [3 /*break*/, 2];
                        vm = viewPortInstruction.viewModel;
                        return [4 /*yield*/, vm()];
                    case 1:
                        $viewModel = _a.sent();
                    ...
                    case 2: throw new Error("moduleId/viewModel not found in " + (viewPortInstruction.name || '') + " viewport/route config");
                }
            });
        });
    }
    ...
    */
    ...
    function _buildNavigationPlan(instruction, forceLifecycleMinimum) {
        return __awaiter(this, void 0, void 0, function () {
            var config, router, newInstruction, params, key, val, redirectLocation, prev, viewPortPlans, defaults, hasNewParams, pending_1, _loop_1, _a, _b, _i, viewPortName, viewPortName, viewPortConfig;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (!prev) return [3 /*break*/, 8];
                        hasNewParams = hasDifferentParameterValues(prev, instruction);
                        pending_1 = [];
                        _loop_1 = function (viewPortName) {
                            var _a, prevViewPortInstruction, nextViewPortConfig, prevViewModelTarget, nextViewModelTarget, viewPortPlan, path, task;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        prevViewPortInstruction = prev.viewPortInstructions[viewPortName];
                                        nextViewPortConfig = viewPortName in config.viewPorts
                                        ...
                                        return [4 /*yield*/, resolveViewModel(prevViewPortInstruction)];
                                    case 1:
                                        prevViewModelTarget = _b.sent();
                                        return [4 /*yield*/, resolveViewModel(nextViewPortConfig)];
                                    case 2:
                                        nextViewModelTarget = _b.sent();
                                        viewPortPlan = viewPortPlans[viewPortName] = {
                                        ...
                                        if (viewPortPlan.strategy !== activationStrategy.replace && prevViewPortInstruction.childRouter) {
                                            path = instruction.getWildcardPath();
                                            task = prevViewPortInstruction
                                                .childRouter
                        ...
                        _a = [];
                        for (_b in prev.viewPortInstructions)
                            _a.push(_b);
                        _i = 0;
                        _c.label = 3;
                    case 3:
                        ...
                        viewPortName = _a[_i];
                        return [5 /*yield**/, _loop_1(viewPortName)];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, Promise.all(pending_1)];
                    case 7:
                        _c.sent();
    ...
    var moduleIdPropName = 'moduleId';
    var viewModelPropName = 'viewModel';
    var PropName;
    (function (PropName) {
    ...
    var CommitChangesStep = /** @class */ (function () {
        ...
        CommitChangesStep.prototype.run = function (navigationInstruction, next) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, navigationInstruction._commitChanges(true)];
                        case 1:
                            _a.sent();
    ...
    var NavigationInstruction = /** @class */ (function () {
        ...
        */
        ...
        NavigationInstruction.prototype.addViewPortInstruction = function (name, instructionOrStrategy, moduleId, component) {
            ...
            var config = Object.assign({}, lifecycleArgs[1], { currentViewPort: name });
        ...
        */
        ...
        NavigationInstruction.prototype._commitChanges = function (waitToSwap) {
            return __awaiter(this, void 0, void 0, function () {
                var router, loads, delaySwaps, _loop_1, this_1, viewPortName;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            router = this.router;
                            ...
                            this_1 = this;
                            for (viewPortName in this.viewPortInstructions) {
    ...
    */
    var Router = /** @class */ (function () {
        ...
        */
        Router.prototype.addRoute = function (config, navModel) {
            ...
            if (Array.isArray(config.route)) {
                var routeConfigs = _ensureArrayWithSingleRoutePerConfig(config);
                routeConfigs.forEach(function (cfg) { return _this.addRoute(cfg, navModel); });
                return;
            }
    ...
    function evaluateNavigationStrategy(instruction, evaluator, context) {
        return Promise
            ...
            .then(function () {
            var routeConfig = instruction.config;
    ...
    */
    ...
    /*@internal*/ function determineWhatToLoad(navigationInstruction, toLoad) {
        ...
        var plans = navigationInstruction.plan;
        var _loop_1 = function (viewPortName) {
            ...
            if (viewPortPlan.strategy === activationStrategy.replace) {
                ...
                var partialInstruction = {
                    strategy: viewPortPlan.strategy,
                    component: viewPortPlan.prevComponent
                };
                var prevViewModel_1 = viewPortPlan.prevViewModel;
                if (typeof prevViewModel_1 === 'string' || prevViewModel_1 === null) {
                    partialInstruction.moduleId = prevViewModel_1;
                }
                else if (typeof prevViewModel_1 === 'function') {
                    partialInstruction.viewModel = function () { return prevViewModel_1; };
                }
                else {
                    throw new Error('Invaid previous view model specification');
                }
                var viewPortInstruction = navigationInstruction.addViewPortInstruction(viewPortName, partialInstruction);
                if (viewPortPlan.childNavigationInstruction) {
    ...
    /*@internal*/ function loadRoute(routeLoader, navigationInstruction, viewPortPlan) {
        return __awaiter(this, void 0, void 0, function () {
            var config, component, partialInstruction, viewPortInstruction, childRouter, path, childInstruction, childPlan;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    */
    var PipelineProvider = /** @class */ (function () {
        ...
        /**@internal */
        PipelineProvider.prototype._buildSteps = function () {
            this.steps = [
        ...
        */
        ...
        PipelineProvider.prototype._findStep = function (name) {
            ...
            return this.steps.find(function (x) { return typeof x === 'object' && (x.slotName === name || x.slotAlias === name); });
        };
        /**
    ...
    */
    var AppRouter = /** @class */ (function (_super) {
        ...
        */
        AppRouter.prototype.registerViewPort = function (viewPort, name) {
            return __awaiter(this, void 0, void 0, function () {
                var viewModel_1, resolveConfiguredPromise;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            viewModel_1 = this._findViewModel(viewPort);
                            if (!('configureRouter' in viewModel_1)) return [3 /*break*/, 3];
                            if (!!this.isConfigured) return [3 /*break*/, 2];
                            resolveConfiguredPromise = this._resolveConfiguredPromise;
                            // tslint:disable-next-line
                            this._resolveConfiguredPromise = function () { };
                            return [4 /*yield*/, this.configure(function (config) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            ...
                            return [3 /*break*/, 6];
                        case 6: return [2 /*return*/, resolveInstruction(instruction, result, !!instructionCount, this)];
                    }
                });
            });
        };
    ...
    function processResult(instruction, result, instructionCount, router) {
        return __awaiter(this, void 0, void 0, function () {
            var finalResult, navigationCommandResult, innerResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // is this necessary
                        return [4 /*yield*/, navigationCommandResult];
                    case 1:
                        // The navigation returns void
                        // is this necessary
                        _a.sent();
                        return [4 /*yield*/, router._dequeueInstruction(instructionCount + 1)];
                    case 2:
                        innerResult = _a.sent();
                        return [2 /*return*/, finalResult || innerResult || result];
                }
            });
        });
    }
